...
describe("Booking Component", () => {
  it("update booking details when date and time are selected", () => {
    render(
      <MemoryRouter>
        <Booking />
      </MemoryRouter>
  ...
  it("allow the user to enter how many players", () => {
    render(
      <MemoryRouter>
        <Booking />
      </MemoryRouter>
...
it("error if there are more than 4 players per lane", () => {
  render(
    <MemoryRouter>
      <Booking />
    </MemoryRouter>
